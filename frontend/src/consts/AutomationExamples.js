...
export const AUTOMATION_EXAMPLES = {
  api_call_example: {
    ...
    description: "Send workflow data to external API endpoint",
    config: {
  ...
  python_script_example: {
    ...
    description:
      "Determine approval requirements based on amount and department",
    config: {
      script_type: "python",
      script: `# Calculate approval amount based on workflow data
...
Workflow System`,
  ...
  database_operation_example: {
    ...
    description: "Insert approval record into database",
    config: {
      operation: "insert",
      table: "approval_logs",
      data: {
  ...
  data_transformation_example: {
    ...
    name: "Field Mapping",
    description: "Transform workflow data to external format",
    config: {
